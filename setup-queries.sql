...
CREATE TABLE Users(
userID INT PRIMARY KEY AUTOINCREMENT NOT NULL,
...
localeID INT PRIMARY KEY AUTOINCREMENT NOT NULL,
...
WHERE userID = 2;
CREATE TABLE Walks(
walkID INT PRIMARY KEY AUTOINCREMENT NOT NULL,
...
activityID INT PRIMARY KEY AUTOINCREMENT NOT NULL,
